...
check_invalid float_overflow 7 'invalid score or course preferences' "${two_courses}X\n1e40 0 1\n"
check_invalid underflowing_score 7 'invalid score or course preferences' "${two_courses}X\n1e-9999 0 1\n"
check_invalid float_underflow 7 'invalid score or course preferences' "${two_courses}X\n1e-50 0 1\n"
